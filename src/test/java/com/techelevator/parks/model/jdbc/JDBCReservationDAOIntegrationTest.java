...
public class JDBCReservationDAOIntegrationTest extends DAOIntegrationTest {
	...
	private static final LocalDate TEST_RESERVATION_1_CREATE_DATE = LocalDate.now();
	private static final long TEST_RESERVATION_2_ID = 2000000;
	private static final String TEST_RESERVATION_2_NAME = "Test Reservation";
	private static final LocalDate TEST_RESERVATION_2_FROM_DATE = LocalDate.of(2020, Month.APRIL, 15);
	private static final LocalDate TEST_RESERVATION_2_TO_DATE = LocalDate.of(2020, Month.JULY, 15);
	private static final LocalDate TEST_RESERVATION_2_CREATE_DATE = LocalDate.now();
	...
	private JDBCReservationDAO dao;
		...
		private Reservation newReservation(long id, long site_id, String name, LocalDate from_date, LocalDate to_date, LocalDate create_date) {
			Reservation theReservation = new Reservation();
			theReservation.setId(id);
			theReservation.setSiteId(site_id);
			theReservation.setName(name);
			theReservation.setFromDate(from_date);
			theReservation.setToDate(to_date);
			theReservation.setCreateDate(create_date);
		...
		public void create_reservation() {
			...
			Reservation expected = newReservation(TEST_RESERVATION_2_ID, TEST_SITE_3_ID, TEST_RESERVATION_2_NAME, TEST_RESERVATION_2_FROM_DATE, TEST_RESERVATION_2_TO_DATE, TEST_RESERVATION_2_CREATE_DATE);
